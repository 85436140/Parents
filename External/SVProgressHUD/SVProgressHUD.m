...
//			if ([string isEqualToString:@"您是群主，不需加入"]|[string isEqualToString:@"用户名或密码错误"]|[string isEqualToString:@"该群组不存在"]|[string isEqualToString:@"您已经加入该群组"]|[string isEqualToString:@"该手机号已注册"]|[string isEqualToString:@"群备注超过长度!"]|[string isEqualToString:@"信息不能为空"]|[string isEqualToString:@"请选择日期"]|[string isEqualToString:@"群组名超过长度!"]|[string isEqualToString:@"服务器错误"]|[string isEqualToString:@"请输入任务内容"]) {
//				self.hudView.hidden = NO;
//			}else
//			{
//			self.hudView.hidden = YES;
//			}
			if ([string isEqualToString:@"成功"]|[string isEqualToString:@"失败"]) {
				self.hudView.hidden = YES;
