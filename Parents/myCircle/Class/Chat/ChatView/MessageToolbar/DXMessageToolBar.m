...
@interface DXMessageToolBar()<UITextViewDelegate, DXFaceDelegate, UITextFieldDelegate,UIScrollViewDelegate>
{
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    if(self.inputTextView.text.length != 0){
        [self.moreButton setFrame:CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight-5, kVerticalPadding+5+20*lines, kInputTextViewMinHeight+5, kInputTextViewMinHeight-10)];
        [self.moreButton setImage:nil forState:UIControlStateNormal];
        [self.moreButton setBackgroundImage:[UIImage imageNamed:@"btn_blue2"] forState:UIControlStateNormal];
        [self.moreButton setTitle:@"发送" forState:UIControlStateNormal];
        [self.moreButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
        [self.moreButton setBackgroundColor:[UIColor blueColor]];
    }else{
        ...
        [self.moreButton setBackgroundColor:[UIColor whiteColor]];
        [self.moreButton setImage:[UIImage imageNamed:@"chatBar_more"] forState:UIControlStateNormal];
        [self.moreButton setFrame:CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight, kVerticalPadding, kInputTextViewMinHeight, kInputTextViewMinHeight)];
    }
}
...
//        faceScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, _toolbarView.frame.size.height, _toolbarView.frame.size.width, keyboardHeight)];
...
//    [self.toolbarView addSubview:faceScrollView];
//
//    pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(98, _toolbarView.frame.size.height-120, 150, 30)];
...
//    
//    [self.toolbarView addSubview:pageControl];
        ...
        case 2://更多
        {
            if (button.selected) {
                ...
                if(self.inputTextView.text.length != 0){
                    [self sendFace];
                    self.inputTextView.text = @"";
                    [self.moreButton.titleLabel setText:@""];
